...
public class TileBag {
    ...
    public TileBag() {
        ...
        for (int i = 0; i < 8; i++) {
            tilesInBag.add(new Tile('A', 1));
        }
        for (int i = 0; i < 2; i++) {
            tilesInBag.add(new Tile('B', 3));
        }
        for (int i = 0; i < 2; i++) {
        ...
        for (int i = 0; i < 10; i++) {
            tilesInBag.add(new Tile('E', 1));
        }
        for (int i = 0; i < 3; i++) {
            tilesInBag.add(new Tile('F', 4));
        }
        for (int i = 0; i < 4; i++) {
            tilesInBag.add(new Tile('G', 2));
        }
        for (int i = 0; i < 3; i++) {
            tilesInBag.add(new Tile('H', 4));
        }
        for (int i = 0; i < 8; i++) {
            tilesInBag.add(new Tile('I', 1));
        }
        for (int i = 0; i < 1; i++) {
            tilesInBag.add(new Tile('J', 9));
        }
        for (int i = 0; i < 1; i++) {
            tilesInBag.add(new Tile('K', 6));
        }
        for (int i = 0; i < 4; i++) {
            tilesInBag.add(new Tile('L', 1));
        }
        for (int i = 0; i < 2; i++) {
            tilesInBag.add(new Tile('M', 3));
        }
        for (int i = 0; i < 7; i++) {
            tilesInBag.add(new Tile('N', 1));
        }
        for (int i = 0; i < 7; i++) {
            tilesInBag.add(new Tile('O', 1));
        }
        for (int i = 0; i < 2; i++) {
            tilesInBag.add(new Tile('P', 3));
        }
        for (int i = 0; i < 1; i++) {
            tilesInBag.add(new Tile('Q', 12));
        }
        for (int i = 0; i < 6; i++) {
            tilesInBag.add(new Tile('R', 1));
        }
        for (int i = 0; i < 4; i++) {
            tilesInBag.add(new Tile('S', 1));
        }
        for (int i = 0; i < 6; i++) {
            tilesInBag.add(new Tile('T', 1));
        }
        for (int i = 0; i < 5; i++) {
            tilesInBag.add(new Tile('U', 1));
        }
        for (int i = 0; i < 2; i++) {
            tilesInBag.add(new Tile('V', 4));
        }
        for (int i = 0; i < 1; i++) {
            tilesInBag.add(new Tile('W', 4));
        }
        for (int i = 0; i < 1; i++) {
            tilesInBag.add(new Tile('X', 9));
        }
        for (int i = 0; i < 2; i++) {
            tilesInBag.add(new Tile('Y', 5));
        }
        for (int i = 0; i < 1; i++) {
            tilesInBag.add(new Tile('Z', 11));
        }
        for (int i = 0; i < 5; i++) {
            tilesInBag.add(new Tile('_', 5)); // Wildcard
        }
    }
    ...
    public Tile getRandomTile() {
        ...
        int index = random.nextInt(tilesInBag.size());
