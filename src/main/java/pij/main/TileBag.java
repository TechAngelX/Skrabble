...
import java.util.*;
    ...
    public class TileBag {
        ...
        // by repeatedly calling a method called getRandomTile seven times. USED ONLY ONCE.
        public HashMap<Character, Integer> createHumanTileRack() {
            HashMap<Character, Integer> playerTileRack = new HashMap<>();
            for (int i = 0; i < 7; i++) {
                char tile = getRandomTile();
                playerTileRack.put(tile, 1);
            }
            return playerTileRack;
        }
